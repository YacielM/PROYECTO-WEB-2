...
router.get('/', estaAutenticado, tieneRol(['admin', 'enfermero','medico']), evaluacionController.listarEvaluaciones);
...
router.get('/detalle/:id', estaAutenticado, tieneRol(['admin', 'enfermero', 'medico']), evaluacionController.verDetalle);
